...
export function HudLayout({ topBar = null, bottomPanel = null, rightColumn = null }: HudLayoutProps) {
  return (
    <div className="pointer-events-none absolute inset-0 z-10 grid grid-cols-[minmax(0,1fr)_auto] grid-rows-[auto_minmax(0,1fr)_auto]" data-testid="hud-layout">
      ...
      <section aria-label="Notifications" className="pointer-events-none col-start-2 row-span-2 row-start-2">
