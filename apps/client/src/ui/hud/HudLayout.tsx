...
export function HudLayout({
  ...
  return (
    ...
    >
      <section aria-label="Top bar" className="pointer-events-none md:col-span-2 col-span-1 row-start-1">
        <div className="pointer-events-auto">{topBar}</div>
      </section>
      <section aria-label="Bottom panel" className="pointer-events-none md:col-start-1 col-start-1 md:row-start-3 row-start-3">
