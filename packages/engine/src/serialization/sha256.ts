 ...
 *
 * Used in place of `node:crypto` so the serialization layer stays runnable in
 * browser bundles. The algorithm is the standard FIPS 180-4 SHA-256, operating
 * on UTF-8 encoded input and returning a lowercase hex digest.
 */
