...
export function stepCost(state: GameState, unit: UnitId, from: HexKey, to: HexKey): number {
...
export function canEnter(state: GameState, unit: UnitId, from: HexKey, to: HexKey): boolean {
